                                ...
                                <Row>
                                    <Col xs={12} md={5}>
                                        ...
                                        <p className='font'>
                                            ...
                                            can also do Data Visualization using Tableau to transform data into a more
                                            readable format to gain better insight.
                                        </p>
                                        <p className='font'>I am also skilled in Data Management on relational databases
                                            like mySQL and non-relational like MongoDB.</p>
                                        <p className='font'>I can also do full stack web development (HTML, CSS and
                                            JavaScript), familiar with MERN stack.</p>
                                        <p className='font'> I also have knowledge in using Illustrator, Photoshop,
                                            InDesign and XD for design. And am fluent in spoken and written English and
                                            Chinese.</p>
